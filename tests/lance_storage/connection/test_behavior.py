...
from tests.lance_storage.connection.fake_tables import (
    _TablesWithAttr,
    _FakeDB,
)
from tests.lance_storage.connection.fake_connection import (
    _FakeConnForInit,
)
...
@pytest.mark.unit
def test_create_articles_table_raises_when_table_exists(initialized_db: Any) -> None:
...
def test_get_articles_table_proxy(monkeypatch: pytest.MonkeyPatch) -> None:
    class _Conn:
        ...
        def get_table(self, name: Any) -> Any:
